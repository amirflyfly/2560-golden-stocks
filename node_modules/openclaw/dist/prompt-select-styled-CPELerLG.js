...
import { $n as getModelRefStatus, An as repairOAuthProfileIdMismatch, Gr as resolveApiKeyForProvider, Hn as updateAuthProfileStoreWithLock, L as writeConfigFile, N as readConfigFileSnapshot, Rn as ensureAuthProfileStore, _i as DEFAULT_PROVIDER, bi as CODEX_CLI_PROFILE_ID, dr as resolveHooksGmailModel, gi as DEFAULT_MODEL, l as resolveApiKeyForProfile, lr as resolveConfiguredModelRef, s as resolveProfileUnusableUntilForDisplay, yi as CLAUDE_CLI_PROFILE_ID } from "./auth-profiles-DSWJsDjg.js";
import { t as formatCliCommand } from "./command-format-DgtG-Rih.js";
import { a as resolveAgentDir, d as resolveDefaultAgentId, g as DEFAULT_AGENTS_FILENAME, u as resolveAgentWorkspaceDir } from "./agent-scope-CU2Re8Hu.js";
import { w as parseAgentSessionKey } from "./session-key-Cuihcz_O.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BYA-qKQw.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-QEqvNlTy.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-YIX-C3S4.js";
import { B as cleanStaleLockFiles, at as formatSessionArchiveTimestamp, c as loadSessionStore, ot as isPrimarySessionTranscriptFileName, tt as resolveMainSessionKey } from "./sessions-vBkENF-W.js";
import { n as listChannelPlugins } from "./plugins-BqHfIRbv.js";
import { _ as loadOpenClawPlugins, ir as resolveAgentSessionDirs, nn as buildAuthHealthSummary, rn as formatRemainingShort, tn as DEFAULT_OAUTH_WARN_MS } from "./subagent-registry-eWk4_pdR.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-CFZJ4dSy.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-_xu4BCM0.js";
import { r as isLoopbackHost, u as resolveGatewayBindHost } from "./net-DRkWvx5J.js";
import { D as DEFAULT_SANDBOX_COMMON_IMAGE, E as DEFAULT_SANDBOX_BROWSER_IMAGE, O as DEFAULT_SANDBOX_IMAGE, p as resolveSandboxScope } from "./sandbox-BjrYR-KB.js";
import { a as resolveGatewayAuth } from "./auth-CdRnR6p1.js";
import { n as inspectPortUsage, o as formatPortDiagnostics } from "./ports-CF8KDGWC.js";
import { i as resolveMemoryBackendConfig } from "./memory-cli-UFDCCjuK.js";
...
import { l as resolveDmAllowState } from "./pi-tools.policy-B-SykSxH.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-DmJ5Vxge.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-CyysiP7z.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-BBtxOcmy.js";
import { t as note$1 } from "./note-CEbCG-nS.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CmgUoPuM.js";
import { d as resolveSystemNodeInfo, l as renderSystemNodeWarning, n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-DuZWKez3.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-B4ocYoH1.js";
import { l as uninstallLegacySystemdUnits, r as isSystemdUserServiceAvailable } from "./systemd-CZE67kXo.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-B8NMhOHq.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-CwmA8vhp.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-3M82m3_J.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-B5cR5D2d.js";
import { r as healthCommand } from "./health-JPTzeBTA.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-C79x5xY2.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-B-gDZES3.js";
import { t as runGatewayUpdate } from "./update-runner-SurIPPUJ.js";
import { n as logConfigUpdated } from "./logging-CR-uu1KB.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-D-sZs6mq.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BXOGoYiW.js";
import { t as formatHealthCheckFailure } from "./health-format-B2TosbwY.js";
import { n as doctorShellCompletion } from "./doctor-completion-C2teCFjA.js";

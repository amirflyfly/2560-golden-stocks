import { d as resolveSessionAgentId, r as resolveAgentConfig } from "./agent-scope-CqCg9ftP.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BjwgLG-1.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BjwgLG-1.js")).closePlaywrightBrowserConnection();
		} catch {}

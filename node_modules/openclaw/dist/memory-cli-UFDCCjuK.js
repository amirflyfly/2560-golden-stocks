...
import { it as parseDurationMs, j as loadConfig, ln as splitShellArgs } from "./auth-profiles-DSWJsDjg.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-CiF2VlPc.js";
import { t as formatDocsLink } from "./links-DMmQqqmC.js";
import { r as withManager } from "./cli-utils-Dp61QuRB.js";
import { t as formatHelpExamples } from "./help-format-Mg63VRVq.js";
import { n as withProgress, r as withProgressTotals } from "./progress-C1ycUGtl.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-Cc515dP9.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-D8h-GoiI.js").then((n) => n.t);

import { D as runExec, P as openBoundaryFile, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME, z as resolvePathViaExistingAncestorSync } from "./agent-scope-XRTwmJgy.js";
...
import { $ as getBlockedNetworkModeReason, I as createConfigIO, L as loadConfig, V as writeConfigFile } from "./model-selection-CbFdKlrW.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-SU51h44n.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-SU51h44n.js")).closePlaywrightBrowserConnection();
		} catch {}

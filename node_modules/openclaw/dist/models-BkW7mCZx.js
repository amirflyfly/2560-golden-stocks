...
import { Fn as upsertAuthProfile, Gn as resolveOpenClawAgentDir, Gr as resolveApiKeyForProvider, Kr as resolveAwsSdkEnvVarName, Mn as listProfilesForProvider, Pn as setAuthProfileOrder, Qn as findNormalizedProviderValue, Qr as shouldEnableShellEnvFallback, Rn as ensureAuthProfileStore, Ur as getCustomProviderApiKey, Wn as resolveAuthStorePathForDisplay, Yr as getShellEnvAppliedKeys, Zn as buildModelAliasIndex, _i as DEFAULT_PROVIDER, ar as normalizeProviderId, fr as resolveModelRefFromString, gi as DEFAULT_MODEL, it as parseDurationMs, j as loadConfig, lr as resolveConfiguredModelRef, n as resolveAuthProfileOrder, nr as modelKey, or as parseModelRef, qr as resolveEnvApiKey, s as resolveProfileUnusableUntilForDisplay, ur as resolveDefaultModelForAgent, vi as resolveAuthProfileDisplayLabel } from "./auth-profiles-DSWJsDjg.js";
import { t as formatCliCommand } from "./command-format-DgtG-Rih.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-CU2Re8Hu.js";
import { r as resolveForwardCompatModel } from "./model-CobB4wfj.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-BqYOh57l.js";
import { Cn as resolveUsageProviderId, Sn as formatUsageWindowSummary, Tt as describeFailoverError, bn as loadProviderUsageSummary, nn as buildAuthHealthSummary, rn as formatRemainingShort, s as runEmbeddedPiAgent, tn as DEFAULT_OAUTH_WARN_MS, wn as maskApiKey } from "./subagent-registry-eWk4_pdR.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CFZJ4dSy.js";
import { t as ensureOpenClawModelsJson } from "./models-config-Ce3wYfYf.js";
import { n as loadModelCatalog } from "./model-catalog-CePudu2Z.js";
import { r as withProgressTotals } from "./progress-C1ycUGtl.js";
import { f as openUrl } from "./onboard-helpers-CyysiP7z.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-D9D8U5Bn.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-B1AevFmV.js";
import { n as logConfigUpdated } from "./logging-CR-uu1KB.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-BaA3VLNr.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./auth-profiles-DSWJsDjg.js").then((n) => n.D);
	const { ensureAuthProfileStore } = await import("./auth-profiles-DSWJsDjg.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CobB4wfj.js").then((n) => n.t);

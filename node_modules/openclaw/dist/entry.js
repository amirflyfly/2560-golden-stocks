...
if (!isMainModule({
	...
	function tryHandleRootHelpFastPath(argv) {
		...
		import("./program-DxTAvqdd.js").then(({ buildProgram }) => {
	...
	if (!ensureExperimentalWarningSuppressed()) {
		...
		if (!tryHandleRootVersionFastPath(process$1.argv) && !tryHandleRootHelpFastPath(process$1.argv)) import("./run-main-CqT35eCd.js").then(({ runCli }) => runCli(process$1.argv)).catch((error) => {

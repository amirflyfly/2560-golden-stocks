...
import { Ct as isAvatarHttpUrl, Dt as isWorkspaceRelativeAvatarPath, Gn as resolveOpenClawAgentDir, St as isAvatarDataUrl, Tt as isPathWithinRoot, _i as DEFAULT_PROVIDER, er as inferUniqueProviderFromConfiguredModels, gi as DEFAULT_MODEL, hi as DEFAULT_CONTEXT_TOKENS, j as loadConfig, kt as resolveAvatarMime, lr as resolveConfiguredModelRef, or as parseModelRef, ur as resolveDefaultModelForAgent, xt as AVATAR_MAX_BYTES } from "./auth-profiles-DSWJsDjg.js";
...
import { a as openBoundaryFileSync } from "./openclaw-root-BYA-qKQw.js";
import { $ as resolveAgentMainSessionKey, M as readSessionTitleFieldsFromTranscript, Q as canonicalizeMainSessionAlias, X as resolveFreshSessionTotalTokens, c as loadSessionStore, st as buildGroupDisplayName, tt as resolveMainSessionKey, w as normalizeSessionDeliveryFields } from "./sessions-vBkENF-W.js";
...
(async () => {
	...
	try {
		const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-BqYOh57l.js").then((n) => n.r);

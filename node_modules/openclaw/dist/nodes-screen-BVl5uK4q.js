...
import { n as resolveSystemRunCommand, t as formatExecCommand } from "./system-run-command-B35atY5U.js";
...
function resolveSystemRunApprovalRequestContext(params) {
	const plan = (normalizeString(params.host) ?? "") === "node" ? normalizeSystemRunApprovalPlan(params.systemRunPlan) : null;

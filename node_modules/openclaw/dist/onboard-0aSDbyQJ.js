...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-CDGdCagb.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-CyysiP7z.js";
import { t as WizardCancelledError } from "./prompts-GoDC3iAV.js";
import { t as createClackPrompter } from "./clack-prompter-ByKEYbqT.js";
import { t as assertSupportedRuntime } from "./runtime-guard-BwU7cq4B.js";
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-B4ocYoH1.js";
import { t as runOnboardingWizard } from "./onboarding-D08z5CyD.js";
import { n as logConfigUpdated } from "./logging-CR-uu1KB.js";
import { i as normalizeLegacyOnboardAuthChoice, r as isDeprecatedAuthChoice, t as ONBOARD_PROVIDER_AUTH_FLAGS } from "./onboard-provider-auth-flags-D2m8TD48.js";
import { t as applyOnboardingLocalWorkspaceConfig } from "./onboard-config-D-YvWJll.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-VwcZvIkR.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-k890ZT3t.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-JPTzeBTA.js").then((n) => n.i);

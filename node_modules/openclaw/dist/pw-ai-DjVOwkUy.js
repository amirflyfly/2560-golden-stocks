...
import { _ as appendCdpPath, b as getHeadersWithAuth, d as normalizeCdpWsUrl, g as withBrowserNavigationPolicy, h as assertBrowserNavigationResultAllowed, m as assertBrowserNavigationAllowed, t as getChromeWebSocketUrl, u as formatAriaSnapshot, v as fetchJson, x as withCdpSocket } from "./chrome-mv_RKsjo.js";
import "./tailnet-DhfP1w4L.js";
import "./ws-DWhvxt3w.js";
import "./path-alias-guards-DRMUAt9X.js";
import { a as resolveStrictExistingPathsWithinRoot, r as DEFAULT_UPLOAD_DIR, s as DEFAULT_FILL_FIELD_TYPE } from "./paths-CUK9133b.js";
...
import { n as markPwAiLoaded } from "./tool-loop-detection-_FRmHUHt.js";
...
function sanitizeFileNameTail(fileName) {
	const trimmed = String(fileName ?? "").trim();
	if (!trimmed) return "output.bin";
	...
	base = cleaned.trim();
	if (!base || base === "." || base === "..") return "output.bin";

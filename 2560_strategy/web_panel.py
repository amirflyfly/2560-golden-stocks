...
def report_summary_text():
    ...
    return f"{month} 月共沉淀 {total} 条记录，其中值得复讲 {worthy} 条（{worthy_rate}%），已成交 {deal} 条，平均咨询数 {avg_inquiry}。"
...
if __name__ == '__main__':
    ...
    print(f'v4.2 server running on http://0.0.0.0:{PORT}')

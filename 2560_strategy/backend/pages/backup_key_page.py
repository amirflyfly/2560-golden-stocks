...
<div class='section card'>
  ...
  <p style='margin-top:12px'><a class='btn' href='/backup-key/download'>下载 backup_hmac_key.txt</a> <a class='btn' href='/backup-key/import'>导入密钥</a> <form method='post' action='/backup-key/rotate' class='inline-form' onsubmit="return confirm('确认轮换密钥？轮换后新备份将使用新签名，系统会保留旧密钥用于验证旧备份。')"><button type='submit' class='linkbtn danger'>轮换密钥</button></form></p>
</div>
"""
